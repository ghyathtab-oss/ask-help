  ...
  return `
    <article class="resident-card resident-select-card ${isSelected ? 'selected' : ''}"
      ...
      <div class="resident-info">
        ...
        <p class="resident-name-en" dir="ltr">${esc(resident.nameEn)}</p>
...
function renderMessage() {
  ...
  el.messageRecipients.innerHTML = selected.length ? selected.map((resident) => `
    <div class="recipient-item">
      ...
      <div><strong>${esc(resident.nameAr)}</strong><small class="recipient-name-en" dir="ltr">${esc(resident.nameEn)}</small><small>${esc(resident.phone)}</small></div>
